...
class MyNuScenesExplorer(NuScenesExplorer):
    ...
    def render_ego_centric_map(self,
        ...
        os.makedirs("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5), exist_ok=True)
        plt.savefig("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/map.png")
        plt.clf()
     ...
     if(True):
       ...
       while has_more_frames:
          ...
          impath, boxes, camera_intrinsic = level5data.get_sample_data(cam['token'],
            box_vis_level=BoxVisibility.ANY)
          im = cv2.imread(impath)
          cv2.imwrite("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/image.png",im)
          ...
          for l in range(10):
              if (l == 0):
                      lid2 = old_lid#level5data.get('sample_data', old_lid['next'])
              else:
                  if not lid2["next"] == "":
              ...
              plt.gca().spines['left'].set_visible(False)
              plt.gca().spines['top'].set_visible(False)
              plt.savefig("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/lidar_"+str(l)+'.png')
              plt.clf()

              fig, axes = plt.subplots(1, 1, figsize=(4, 4))
              #object render
              for box in boxes:
                  box_int = random.randint(0, 1)
                  if(box_int==0):
              ...
              plt.gca().spines['left'].set_visible(False)
              plt.gca().spines['top'].set_visible(False)
              plt.savefig("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/bbox_"+str(l)+'.png')
              plt.clf()
          ...
          for p in range(10):
                   ...
                   poly = plt.Polygon((points[0:2,0],points[0:2,1],points[0:2,2],points[0:2,3]),color=(1.0,0,0))
                   ...
                   plt.gca().spines['left'].set_visible(False)
                   plt.gca().spines['top'].set_visible(False)
                   plt.savefig("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/ego_pose_"+str(p)+".png")
          ...
          with open("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+".csv", 'a') as csvfile:
          ...
          plt.gca().spines['left'].set_visible(False)
          plt.gca().spines['top'].set_visible(False)
          plt.savefig("/work5/s_seiya/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/waypoint.png")
          plt.clf()
