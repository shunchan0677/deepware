...
def CNN(cell1, input_state1, cell2, input_state2, cell3, input_state3, cell4, input_state4, cell5, input_state5, image, keep_prob):
    ...
    output5_ = tf.reshape(output5,[-1]+[256,256]+[1])
...
if __name__ == '__main__':
    ...
    cell5 = ConvLSTMCell([256,256], 1, [3, 3],"5",activation=tf.sigmoid)
    ...
    y_conv,output_state1,output_state2,output_state3,output_state4,output_state5,diff = CNN(cell1, input_state1,cell2, input_state2,cell3, input_state3,cell4, input_state4, cell5, input_state5, image1, keep_prob)
        ...
        for i, train_data in enumerate(train_new_generator):
            if not train_data:
                ...
                for m in range(8):
                   if(m <= 3):
                       loss_tmp = sess.run([train_step,loss,loss2,loss_gen,output_state1,output_state2,output_state3,output_state4,output_state5,y_conv], feed_dict={
                              image1: [train_image[:,m+1,:,:,:]],input_state1:mid_state1,input_state2:mid_state2,input_state3:mid_state3,input_state4:mid_state4,input_state5:mid_state5, y_r: [train_r[:,m+2,:,:,:]], keep_prob: 0.5})
                       loss_a += loss_tmp[1]
                       loss_b += loss_tmp[2]
                       loss_c += loss_tmp[3]
                       mid_state1 = loss_tmp[4]
                       ...
                       loss_tmp = sess.run([train_step,loss,loss2,loss_gen,output_state1,output_state2,output_state3,output_state4,output_state5,y_conv], feed_dict={
                              image1: [output_image],input_state1:mid_state1,input_state2:mid_state2,input_state3:mid_state3,input_state4:mid_state4,input_state5:mid_state5, y_r: [train_r[:,m+2,:,:,:]], keep_prob: 0.5})
                       loss_a += loss_tmp[1]
                       loss_b += loss_tmp[2]
                       loss_c += loss_tmp[3]
                       mid_state1 = loss_tmp[4]
                    ...
                    for m in range(9):
                        if(m <= 3):
                           loss_, states_1, states_2, states_3, states_4,states_5,output_image = sess.run([loss,output_state1,output_state2,output_state3,output_state4,output_state5,y_conv], feed_dict={
                                 image1: [test_image[:,m+1,:,:,:]], input_state1:state_test1,input_state2:state_test2,input_state3:state_test3,input_state4:state_test4,input_state5:state_test5, y_r: [test_r[:,m+2,:,:,:]], keep_prob: 1.0})
                        else:
                           loss_, states_1, states_2, states_3, states_4, states_5,output_image = sess.run([loss,output_state1,output_state2,output_state3,output_state4,output_state5,y_conv], feed_dict={
                                 image1: [(output_image > 0.5) * 1.0], input_state1:state_test1,input_state2:state_test2,input_state3:state_test3,input_state4:state_test4,input_state5:state_test5, y_r: [test_r[:,m+2,:,:,:]], keep_prob: 1.0})
