...
if __name__ == '__main__':
    ...
    image1 = tf.placeholder(tf.float32, [None,None] + [256, 256]+ [1])
        ...
        for i, train_data in enumerate(train_new_generator):
            if not train_data:
                ...
                for m in range(4):
                   ...
                   mid_state1 = loss_tmp[4]
                   output_image = (loss_tmp[5] > 0.5) * 1.0
                   train_image[:,m+6,:,:,:] = output_image[m+5,:,:,:]
                if(i % 1000 == 0 and i != 0):
                ...
                if not test_data:
                    ...
                    for m in range(4):
                        ...
                        if(True):
                           rmse += loss_
                        state_test1 = states_1
                        test_image[:,m+6,:,:,:] = output_image[m+5,:,:,:]
