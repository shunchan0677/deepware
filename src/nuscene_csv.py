...
class MyNuScenesExplorer(NuScenesExplorer):
    ...
    def render_ego_centric_map(self,
        ...
        os.makedirs("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5), exist_ok=True)
        plt.savefig("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/map.png")
        plt.clf()
     ...
     if(k<81 and k>=74):
       ...
       while has_more_frames:
          ...
          impath, boxes, camera_intrinsic = level5data.get_sample_data(cam['token'],
            box_vis_level=BoxVisibility.ANY)
          im = cv2.imread(impath)
          cv2.imwrite("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/image.png",im)
          ...
          for l in range(10):
              ...
              plt.gca().spines['left'].set_visible(False)
              plt.gca().spines['top'].set_visible(False)
              plt.savefig("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/lidar_"+str(l)+'.png')
              plt.clf()
              ...
              plt.gca().spines['left'].set_visible(False)
              plt.gca().spines['top'].set_visible(False)
              plt.savefig("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/bbox_"+str(l)+'.png')
              plt.clf()
          ...
          for p in range(10):
                   ...
                   plt.gca().spines['left'].set_visible(False)
                   plt.gca().spines['top'].set_visible(False)
                   plt.savefig("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/ego_pose_"+str(p)+".png")
          ...
          with open("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+".csv", 'a') as csvfile:
          ...
          plt.gca().spines['left'].set_visible(False)
          plt.gca().spines['top'].set_visible(False)
          plt.savefig("/mnt/fs_meti/level5dataset2/v1.01-train/dataset/scene"+str(k).zfill(5)+"/data"+str(j).zfill(5)+"/waypoint.png")
          plt.clf()
